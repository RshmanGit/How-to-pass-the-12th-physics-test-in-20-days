...
**Definition *(1m)*** — Acquired **progressive** decline in ≥2 cognitive domains causing loss of function,
with **clear consciousness** (vs delirium).
**Causes/types *(1½m)*** — **Alzheimer's** (commonest), **vascular**, **Lewy body**, **frontotemporal**;
reversible mimics — B12 deficiency, hypothyroidism, NPH, depression ("pseudodementia").
**Assessment *(1½m)*** — Cognitive testing (**MMSE/MoCA**); bloods (B12, TFT, calcium, glucose);
**neuroimaging (CT/MRI)** to exclude reversible/structural cause.
